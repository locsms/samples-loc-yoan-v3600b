...
(30,Portal,sample_Yoan_Back,ROOT,INSTALL.sql,2019040 03:52:56,@DJSF @FMT(T6F,@NOW),08BB7C9C),
(30,Portal,sample_Yoan_Back,OFFICE,Samples.ini,2024127 14:55:40,@DJSF @FMT(T6F,@NOW),7A43773C),
