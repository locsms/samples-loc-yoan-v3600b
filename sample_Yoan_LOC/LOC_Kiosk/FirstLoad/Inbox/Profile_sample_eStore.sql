...
('PAL','XSTORE','Remote/eStore_kiosk','kioskCarouselTime','5'),
('PAL','XSTORE','Remote/eStore_kiosk','kioskMiniCart','0'),
('PAL','XSTORE','Remote/eStore_kiosk','timeout','60'),
('PAL','XSTORE','Remote/eStore_kiosk','isNameRequired','0'),
('PAL','XSTORE','Remote/eStore_kiosk/PRN1','OrderMode','DELI'),
('PAL','XSTORE','Remote/eStore_kiosk/PRN1','OrderText','Order from deli counter'),
('PAL','XSTORE','Remote/eStore_kiosk/PRN2','OrderMode','FOODB'),
('PAL','XSTORE','Remote/eStore_kiosk/PRN2','OrderText','Order from food counter'),
('PAL','XSTORE','Remote/eStore_kiosk/PRN3','OrderMode','FOODT'),
('PAL','XSTORE','Remote/eStore_kiosk/PRN3','OrderText','Order from coffee shop'),
('PAL','XSTORE','Remote/eStore_kiosk','OrderMode','ORDER'),
('PAL','XSTORE','Remote/eStore_kiosk','OrderText','Order for pickup/delivery'),
