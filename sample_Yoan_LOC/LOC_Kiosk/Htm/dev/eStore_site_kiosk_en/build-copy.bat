...
xcopy "..\eStore_kiosk_en\app\*.*" "..\eStore\app\" /s /e /y /i
xcopy "..\eStore_kiosk_en\overrides\*.*" "..\eStore\overrides\" /s /e /y /i
xcopy "..\eStore_kiosk_en\resources\*.*" "..\eStore\resources\" /s /e /y /i

xcopy "..\eStore_site_kiosk_en\app\*.*" "..\eStore\app\" /s /e /y /i
xcopy "..\eStore_site_kiosk_en\overrides\*.*" "..\eStore\overrides\" /s /e /y /i
xcopy "..\eStore_site_kiosk_en\resources\*.*" "..\eStore\resources\" /s /e /y /i
