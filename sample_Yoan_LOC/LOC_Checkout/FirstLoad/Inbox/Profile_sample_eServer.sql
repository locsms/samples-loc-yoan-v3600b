...
('PAL','DEFAULT','HOT_RPLG_eServer_base_clt','bonusFull',''),
('PAL','DEFAULT','HOT_RPLG_eServer_base_clt','bonusNew',''),
('PAL','DEFAULT','HOT_RPLG_eServer_base_clt','defaultRisk','1'),
('PAL','DEFAULT','HOT_RPLG_eServer_base_clt','defaultShopper','2'),
('PAL','DEFAULT','HOT_RPLG_eServer_base_clt','defaultStatus','NOCAPTCHA'),
...
('PAL','XSTORE','Trs','HDRSALF1068','SALE'),
