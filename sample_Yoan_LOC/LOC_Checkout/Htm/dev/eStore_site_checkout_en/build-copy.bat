...
xcopy "..\eStore_checkout_en\app\*.*" "..\eStore\app\" /s /e /y /i
xcopy "..\eStore_checkout_en\overrides\*.*" "..\eStore\overrides\" /s /e /y /i
xcopy "..\eStore_checkout_en\resources\*.*" "..\eStore\resources\" /s /e /y /i

xcopy "..\eStore_site_checkout_en\app\*.*" "..\eStore\app\" /s /e /y /i
xcopy "..\eStore_site_checkout_en\overrides\*.*" "..\eStore\overrides\" /s /e /y /i
xcopy "..\eStore_site_checkout_en\resources\*.*" "..\eStore\resources\" /s /e /y /i
