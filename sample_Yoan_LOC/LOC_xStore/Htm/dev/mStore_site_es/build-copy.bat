...
xcopy "..\mStore_base_es\app\*.*" "..\mStore\app\" /s /e /y /i
xcopy "..\mStore_base_es\overrides\*.*" "..\mStore\overrides\" /s /e /y /i
xcopy "..\mStore_base_es\resources\*.*" "..\mStore\resources\" /s /e /y /i
...
xcopy "..\mStore_site_es\app\*.*" "..\mStore\app\" /s /e /y /i
xcopy "..\mStore_site_es\overrides\*.*" "..\mStore\overrides\" /s /e /y /i
xcopy "..\mStore_site_es\resources\*.*" "..\mStore\resources\" /s /e /y /i
