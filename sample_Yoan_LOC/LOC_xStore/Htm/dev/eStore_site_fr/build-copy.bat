...
xcopy "..\eStore_site_fr\app\*.*" "..\eStore\app\" /s /e /y /i
xcopy "..\eStore_site_fr\overrides\*.*" "..\eStore\overrides\" /s /e /y /i
xcopy "..\eStore_site_fr\resources\*.*" "..\eStore\resources\" /s /e /y /i
